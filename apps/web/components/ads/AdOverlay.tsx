...
/**
 * AdOverlay.tsx — Overlay de countdown para Monetag Vignette
 *
 * El Vignette de Monetag se muestra encima de todo con su propio z-index.
 * Este overlay bloquea la UI de Turrinder y muestra el countdown.
 * Una vez que pasan los segundos, se habilita "Continuar".
 *
 * No necesita adContainerRef — Monetag maneja su propio rendering.
 */
    ...
    <>
      <style>{`
        ...
        .adov-root {
          ...
          /* z-index por debajo del vignette de Monetag (que usa z-index muy alto)
             pero encima de todo lo de Turrinder */
          z-index: 8000;
        ...
        .adov-eyebrow {
          font-size: 9px; color: rgba(255,255,255,0.22); letter-spacing: 3px;
        ...
        .adov-message-icon { font-size: 36px; }
        .adov-message-title {
          font-family: 'Syne', sans-serif; font-size: 17px; font-weight: 800;
          color: rgba(255,255,255,0.85);
        }
        .adov-message-sub {
          font-size: 12px; color: rgba(255,255,255,0.35); line-height: 1.6; max-width: 260px;
        }
        ...
        .adov-progress-fill {
          height: 100%; background: linear-gradient(90deg, #ff6b35, #ff2d6b);
        ...
        .adov-btn-ready {
          background: linear-gradient(135deg, #ff6b35, #ff2d6b); color: white;
          box-shadow: 0 4px 20px rgba(255,45,107,0.4);
          animation: btnPulse 2s ease-in-out infinite;
        }
        .adov-btn-ready:hover { transform: translateY(-2px) scale(1.04); box-shadow: 0 8px 28px rgba(255,45,107,0.6); }
        @keyframes btnPulse {
          0%,100%{box-shadow:0 4px 20px rgba(255,45,107,0.4);}
          50%{box-shadow:0 4px 28px rgba(255,45,107,0.65),0 0 0 6px rgba(255,45,107,0.05);}
        }
      ...
      <div className={`adov-root ${exiting ? "exiting" : ""}`}>
        ...
        <div className="adov-message">
          <div className="adov-message-icon">
            {canContinue ? "✅" : "📺"}
          </div>
          <div className="adov-message-title">
            {canContinue ? "¡Gracias por ver el anuncio!" : "Viendo anuncio..."}
          </div>
          <div className="adov-message-sub">
            {canContinue
              ? "Ya podés continuar con Turrinder."
              : "El anuncio apareció en pantalla. Esperá unos segundos para continuar."
            }
          </div>
        </div>
