...
/**
 * AdOverlay.tsx — Modal fullscreen con banner 300x250 embebido
 *
 * El div `adContainerRef` recibe el iframe de Adsterra directamente.
 * El botón "Continuar" se habilita cuando el countdown llega a 0.
 */
  ...
  return (
    <>
      <style>{`
        ...
        .adov-banner-wrap.loaded { animation:none; background:transparent; }

        .adov-banner-placeholder {
          display:flex; flex-direction:column; align-items:center; gap:8px;
          color:rgba(255,255,255,0.15); font-size:11px; letter-spacing:1px;
          text-transform:uppercase; pointer-events:none;
          position:absolute;
        }
        .adov-banner-placeholder-icon { font-size:24px; opacity:0.25; }

        /* El div real donde va el iframe de Adsterra */
        .adov-ad-slot {
        ...
        .adov-progress-labels {
          ...
          margin-top:7px; font-size:10px; color:rgba(255,255,255,0.2);
        }
        ...
        .adov-btn {
          ...
          padding:13px 40px; cursor:pointer; min-width:200px;
      ...
      <div className={`adov-root ${exiting ? "exiting" : ""}`}>
        ...
        {/* Banner Adsterra — el div donde se inyecta el iframe */}
        <div className="adov-banner-wrap">
          <div className="adov-banner-placeholder">
            <div className="adov-banner-placeholder-icon">📺</div>
            <span>Cargando anuncio...</span>
          </div>
          {/* Este div recibe el script de Adsterra vía adContainerRef */}
